  ...
  return (
    <div style={{ fontFamily: "'Georgia', serif", background: "#FEFAF4", minHeight: "100vh", color: "#1A1208" }}>
      ...
      {(activeCategory === "All" || activeCategory === "Meal Prep") && (
        <div style={{ background: "linear-gradient(135deg, #0F3D1A 0%, #1A6B2E 50%, #4A1B6B 100%)", margin: "0 32px 32px", borderRadius: "16px", padding: "18px 28px", display: "flex", alignItems: "center", justifyContent: "center", gap: "14px", flexWrap: "wrap" }}>
